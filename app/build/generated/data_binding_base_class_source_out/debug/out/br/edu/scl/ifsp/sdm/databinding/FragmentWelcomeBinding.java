...
public final class FragmentWelcomeBinding implements ViewBinding {
  ...
  @NonNull
  public final Button playerBt;

  @NonNull
  public final TextView welcomeTv;

  private FragmentWelcomeBinding(@NonNull ConstraintLayout rootView, @NonNull Button playerBt,
  ...
  public static FragmentWelcomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.playerBt;
      Button playerBt = ViewBindings.findChildViewById(rootView, id);
      if (playerBt == null) {
        break missingId;
      }
      ...
      return new FragmentWelcomeBinding((ConstraintLayout) rootView, playerBt, welcomeTv);
    }
